...
const Header = () => {
  ...
  return (
    <div className='bg-[#fff] shadow h-[100px] flex items-center justify-between px-[100px] py-[26px]'>
        <img src={Logo} alt='Logo' className='' onClick={() => navigate("/")} />
        <div className='flex items-center gap-[44px]'>

            {/* <div className='w-[593px] h-[48px] gap-2 border border-[#E1E3E2] rounded-lg p-3 flex items-center'>
                <select
                    name='categories'
                    className=' outline-none flex  w-[139px] h-[24px] items-center justify-center'
                >
                    <option>All Categories</option>
                </select>
                <div className='h-[21px] w-[2px] bg-[#8D9290]'></div>
